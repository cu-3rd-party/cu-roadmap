...
export function RoadmapResult({roadmap, onReset, onEditSettings, fixPrereq}: RoadmapResultProps) {
    return (
        <div className="flex flex-col">
            <div className="text-center mb-6">
                <div
                    className="inline-flex items-center gap-2 bg-green-100 text-green-700 px-4 py-2 rounded-full text-sm font-bold mb-3">
