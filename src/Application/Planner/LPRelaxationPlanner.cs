...
public class LPRelaxationPlanner : IRoadmapPlanner
{
    private readonly IApplicationDbContext _context;

    public LPRelaxationPlanner(IApplicationDbContext context) => _context = context;
        ...
        double maxLoad, int cohort, CancellationToken ct = default)
    {
        return await RoadmapPlannerImpl.GenerateRoadmapWithStrategyAsync(
            ...
            maxLoad, cohort,
            RoadmapPlannerImpl.SelectLPRelaxationSemester, ct);
    }
}
