...
public class GreedyPlanner : IRoadmapPlanner
{
    private readonly IApplicationDbContext _context;

    public GreedyPlanner(IApplicationDbContext context) => _context = context;
        ...
        double maxLoad, int cohort, CancellationToken ct = default)
    {
        return await RoadmapPlannerImpl.GenerateRoadmapWithStrategyAsync(
            ...
            maxLoad, cohort,
            RoadmapPlannerImpl.SelectGreedySemester, ct);
    }
}
