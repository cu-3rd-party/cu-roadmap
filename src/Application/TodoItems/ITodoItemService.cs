namespace CuRoadmap.Application.TodoItems;
...
public interface ITodoItemService
{
    ...
    Task UpdateDetailAsync(int id, int listId, Domain.Enums.PriorityLevel priority, string? note, CancellationToken cancellationToken = default);
}
