...
public class TodoItems : IEndpointGroup
{
    ...
    public static async Task<Results<NoContent, BadRequest>> UpdateTodoItem(ITodoItemService service, int id, UpdateTodoItemRequest request)
    {
        if (id != request.Id)
    ...
    public static async Task<Results<NoContent, BadRequest>> UpdateTodoItemDetail(ITodoItemService service, int id, UpdateTodoItemDetailRequest request)
    {
