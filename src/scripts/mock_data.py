...
from src.domain.models import Base, Course, Major, MajorRequirement, RequirementType, Student
...
async def mock_data():
    async with async_session() as session:
        ...
        swe_courses = [
            "Разработка на Python. Основной", "Разработка на Python. Углублённый", 
            "Алгоритмы и структуры данных I", "Алгоритмы и структуры данных 2",
            "Архитектура компьютера и ОС", "Архитектура компьютера и ОС 2", "Базы данных", 
            "Основы промышленной разработки", "Основы разработки на Go", "Web-разработка"
        ]
        
        ai_courses = [
            "Разработка на Python. Основной", "Разработка на Python. Углублённый",
            "Machine Learning", "Deep Learning", "Введение в ИИ",
            "Теория вероятностей и матстатистика", "Математическая статистика",
            "Линейная алгебра и геометрия", "Математический анализ"
        ]
        ...
        common_courses = [
            "Командная работа по Agile", "Стресс-менеджмент", "Информационная безопасность"
        ]
        ...
        student = Student(
            ...
            cohort=2025,
            current_semester=3,
            target_major_id=majors["Software Engineering"].id if "Software Engineering" in majors else None
        )
        
        # Student passed some basic courses already
        passed_titles = ["Разработка на Python. Основной", "Архитектура компьютера и ОС", "Командная работа по Agile"]
